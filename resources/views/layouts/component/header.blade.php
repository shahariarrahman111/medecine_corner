            ...
            <div class="row align-items-center">
                <div class="col-xxl-4 col-xl-3">
                    <div class="topbar-info d-none d-xl-block">
                        <p class="text-white fs-sm fw-medium mb-0">Welcome to our Medicine store</p>
                    </div>
                </div>
                        ...
                        <div
                            ...
                            <div class="gshop-header-search dropdown">
                                <button type="button" class="header-icon" data-bs-toggle="dropdown">
                                    <svg width="18" height="23" viewBox="0 0 22 23" fill=""
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div class="user-menu-wrapper">
                                    @auth
                                        <ul class="user-menu">
                                            ...
                                            <li><a href="{{ route('customer.wishlist') }}"><span class="me-2"><i

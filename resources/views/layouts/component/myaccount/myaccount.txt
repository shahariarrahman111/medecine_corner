                ...
                <div class="tab-content">
                            ...
                            <div class="table-responsive">
                                <table class="order-history-table table">
                                    ...
                                    <tr>
                                        ...
                                        <td>COD</td>
                                        <td class="thumbnail">
                                            <img src=" {{ asset('backend/assets/images/products/cauliflower-xs.png') }}"
                                                alt="product" />
                                        </td>
                                    ...
                                    <tr>
                                        <td class="d-flex align-items-center gap-3">
                                            <span
                                                ...
                                                <img src=" {{ asset('backend/assets/images/brands/paypal-icon.png') }}"
                                                    alt="icon" />
                                            </span>
                    ...
                    <div class="tab-pane fade" id="update-profile">
                        ...
                        <div class="change-password bg-white py-5 px-4 mt-4 rounded">
                            ...
                            <form action="{{ route('change.password') }}" method="POST" class="password-reset-form"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row g-4">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="label-input-field">
                                            ...
                                            <input type="password" name="old_password"
                                                ...
                                                id="old_password" autocomplete="off" placeholder="Current password">
                                            @error('old_password')
